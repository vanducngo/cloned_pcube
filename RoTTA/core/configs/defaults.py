...
_C.P_CUBE = CN()
_C.P_CUBE.BATCH_SIZE = 64
_C.P_CUBE.CAPACITY = 64
_C.P_CUBE.MAX_AGE = 1024
_C.P_CUBE.ACCELERATION_FACTOR = 100
_C.P_CUBE.KL_CHECK_INTERVAL = 64
_C.P_CUBE.KL_THRESHOLD = 5.0
_C.P_CUBE.EMA_MOMENTUM = 0.9
_C.P_CUBE.LAMBDA_T = 1.0
_C.P_CUBE.LAMBDA_U = 1.0

_C.P_CUBE.FILTER = CN()
_C.P_CUBE.FILTER.ODP_RATIO = 0.1
_C.P_CUBE.FILTER.ODP_THRESHOLD = 0.2
_C.P_CUBE.FILTER.ENTROPY_FACTOR = 0.5

_C.P_CUBE.REPLAY = CN()
_C.P_CUBE.REPLAY.NUM_AUG_CHECKS = 2
_C.P_CUBE.REPLAY.W_ENT = 1.0
_C.P_CUBE.REPLAY.W_DIS = 0.5
_C.P_CUBE.REPLAY.WEIGHT_TEMP = 1.0
